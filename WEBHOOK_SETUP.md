# 🔄 Повністю автоматичне відстеження оплат BMC

## ⚡ Як це працює (ПОВНІСТЮ АВТОМАТИЧНО):

1. **Користувач обирає суму** в Web App ($10)
2. **Web App відправляє дані** боту (user_id, amount, timestamp)
3. **Бот зберігає** pending payment в БД
4. **Користувач оплачує** на Buy Me a Coffee - **просто оплата, нічого не вказує!** ✅
5. **BMC відправляє webhook** на ваш сервер (через 1-2 хвилини)
6. **Webhook handler автоматично шукає** pending payment по **сумі + часу** (±30 хвилин)
7. **Автоматично зараховує** бонуси користувачу! 🎉

**Користувач не вказує жодних ID, коду чи іншої інформації - просто оплачує!**
